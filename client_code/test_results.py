...
def cast_votes():
    ...
    voter_0_1 = Voter(polling_station_name="PS1", voter_name="John B", authentication_strategy=NationalInsuranceNumber(ni_number="123456789"))
    ...
    voter_2 = Voter(polling_station_name="PS5", voter_name="John A", authentication_strategy=NationalInsuranceNumber(ni_number="153456791"))
